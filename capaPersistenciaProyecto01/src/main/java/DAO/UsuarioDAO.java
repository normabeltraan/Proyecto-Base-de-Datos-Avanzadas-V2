...
/**
 * Esta clase implementa la interfaz IUsuarioDAO se encarga de gestionar a los usuarios ya sean paciente o médico.
 * 
...
public class UsuarioDAO implements IUsuarioDAO {
    ...
    /**
     * Este método registra un nuevo usuario junto con sus datos de paciente en la base de datos.
     * La contraseña del usuario es encriptada antes de almacenarse.
     * 
     * @param usuario El objeto usuario con los datos de autenticación.
     * @param paciente El objeto paciente con la información personal del paciente.
     * @return Regresa verdadero si el registro fue exitoso, falso en caso contrario.
    ...
    /**
     * Este método verifica si las credenciales del usuario son correctas para iniciar sesión.
     ...
     * @return Regresa verdadero si la autenticación es exitosa, falso si las credenciales no coinciden.
     * @throws PersistenciaException Lanzará una excepción si ocurre un error furante la consulta a la base de datos.
     */
    @Override
    ...
    /**
     * Este método comprueba si un nombre de usuario ya existe en la base de datos.
     * 
     * @param nombreUsuario El nombre de usuario a verificar.
     * @return Regresa verdadero si el nombre de usuario ya está registrado, falso si está disponible.
    ...
    /**
     * Este método comprueba si un correo electrónico ya está registrado en la base de datos.
     * 
     * @param correoElectronico El correo electrónico a verificar.
     * @return Regresa verdadero si el correo ya está registrado, falso si está disponible.
     * @throws PersistenciaException Lanzará una excepción si ocurre un error durante la consulta.
     */
    @Override
     ...
     * Puede ser paciente o médico.
     * 
     * @param nombreUsuario El nombre del usuario a consultar.
     * @return Regresa la cadena que indica el tipo de usuario.
     * @throws PersistenciaException Lanzará una excepción si ocurre un error en la consulta.
     */
    @Override
