...
/**
 * Esta clase representa los horarios que si estén disponibles para consultas que sean de 30 minutos no pueden ser ni más ni menos.
 * Más que nada se usa para hacer más sencillo el manejo de las consultas.
 * 
...
public class HorarioDisponible {
     ...
     */
    public HorarioDisponible(Date fecha, Time hora_disponible) {
        this.fecha = fecha;
