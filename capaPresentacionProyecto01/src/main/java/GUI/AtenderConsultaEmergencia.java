...
public class AtenderConsultaEmergencia extends javax.swing.JFrame {
     ...
     */
    public AtenderConsultaEmergencia() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtenderConsultaEmergencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AtenderConsultaEmergencia().setVisible(true);
            }
        });
    }
