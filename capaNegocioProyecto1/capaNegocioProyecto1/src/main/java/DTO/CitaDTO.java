...
/**
 * Esta clase que representa un objeto de transferencia de datos (DTO) para la entidad Cita.
 * Se utiliza para transportar información de las citas entre las distintas capas del sistema.
 * 
...
public class CitaDTO 
{
    ...
    /**
     * Constructor que inicializa los atributos importantes de la cita.
     ...
     * @return Regresa la cadena de texto con la información de la cita DTO.
     */
    @Override
